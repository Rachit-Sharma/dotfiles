...
Don't lose track of cursor when jumping around.
...
Automatically revert buffer if file is changed
...
=M-;= does comment, but the behaviour sometimes isn't exactly what you'd expect
